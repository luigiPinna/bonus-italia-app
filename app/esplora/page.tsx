...
export default function EsploraPage() {
  ...
  const [filtri, setFiltri] = useState<Filtri>({
    ...
    isee: [],
    categorie: initialCategoria ? [initialCategoria] : [],
    tipologie: [],
    eta_figli: [],
    status: [],
  });
  ...
  useEffect(() => {
    ...
    setFiltri(prev => ({
      ...prev,
      search,
      categorie: categoria ? [categoria] : prev.categorie,
    }));
  }, [searchParams]);
  ...
  return (
    <div className="flex flex-col min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 py-6 flex-1">
        <div className="mb-6">
          <h1 className="text-3xl font-bold text-foreground">Esplora tutti i bonus</h1>
          <p className="text-muted-foreground mt-2">Trova i bonus e gli incentivi giusti per te</p>
        </div>
